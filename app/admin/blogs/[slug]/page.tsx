...
export default function EditBlog({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-[#F4F4F5] pt-32 px-5 md:px-16 pb-24 text-zinc-900 font-body-md">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-zinc-200 p-8 md:p-10">
          <h1 className="font-headline-lg text-3xl text-zinc-900 mb-8 tracking-tight">
            Edit Post
          </h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white border border-zinc-300 rounded-lg focus:outline-none focus:border-brand-vibrancy transition-shadow text-lg text-zinc-900 placeholder:text-zinc-400"
                required
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              {editSlug && (
                <p className="text-xs text-zinc-500">Preview: <span className="text-brand-vibrancy">/blog-details/{editSlug}</span></p>
              )}
            </div>
                  ...
                  <div className="flex items-center gap-1 border-b border-zinc-200 p-2 bg-zinc-50 text-zinc-700">
                    {[
                      ...
                      <button
                        ...
                        type="button"
                        onClick={btn.action}
                        className={`p-2 rounded-lg transition-colors ${btn.active ? 'bg-zinc-200 text-zinc-900' : 'text-zinc-600 hover:bg-zinc-100 hover:text-zinc-900'}`}
                      >
                        <btn.icon size={16} />
                      </button>
                    ))}
            ...
            <div className="pt-8 border-t border-zinc-200 mt-4 flex flex-col gap-4">
              {error && (
